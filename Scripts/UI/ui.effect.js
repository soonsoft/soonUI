; (function () {
    ...
    var Wave = function (canvas, option) {
        ...
        this.changeColor(option.color || "#FFFFFF", option.bgColor || "#535354");
    ...
    Wave.prototype = {
        ...
        _drawLine: function (attenuation, color, width, k, f) {
            ...
            for (var i = -k; i <= k; i += 0.01) {
                ...
                y = this.height / 2 + this.peak * this._globalAttenuationFn(i, k) * (1 / attenuation) * (Math.sin(f * i * .2 - this.phase) - .5);
                y *= this.waterHeight;
        ...
        _fillStyle: function() {
            ...
            gradient.addColorStop(0, ui.str.stringFormat("rgba({0}, 0)", this.rgbColor));
            gradient.addColorStop(1, ui.str.stringFormat("rgba({0}, 1)", this.rgbBGColor));
        ...
        changeColor: function (color, bgColor) {
            this.color = color;
            var rgb = ui.color.hex2rgb(color);
            this.rgbColor = rgb.join(",");

            if (bgColor) {
                this.bgColor = bgColor;
                rgb = ui.color.hex2rgb(bgColor);
                this.rgbBGColor = rgb.join(",")
            }
        }
    };
    ...
    (function () {
        ...
        brilliant = function (canvas, option) {
            if (!option) option = {};
            var t = {
                width: 1.5,
                height: 1.5,
            ...
            var G = {
                ...
                xyScalar: 1,
                zOffset: 100,
                ambient: option.darkColor || "#19243D",
                diffuse: option.lightColor || "#3E5A99",
                speed: 0.001,
                gravity: 1200,
                dampening: 0.95,
                minLimit: 10,
            ...
            function F() {
                ...
                g.element = canvas.get(0);
                g.context = g.element.getContext("2d");
                H(x.renderer);
            }
            function H(N) {
                if (D) {
            ...
            brilliantChangeColor = function (lightColor, darkColor) {
                J([lightColor, darkColor]).set();
            };
            brilliantStart = function () {
                i = Date.now() - n;
                u();
                M();
                requestAnimationFrame(brilliantStart);
            };
        };
    })();
    ...
    var effects = {
        ...
        brilliant: function (canvas, option) {
            ...
            if (!!canvas) {
                ...
                brilliant(canvas, option);
                b = {
                    changeColor: brilliantChangeColor,
                    start: brilliantStart
                };
            }
            return b;
        }
