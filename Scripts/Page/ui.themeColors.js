;(function(ui) {
	...
	ui.docReady(function(e) {
		...
		themeId = theme.prop("href");
		themeId = themeId.substr(themeId.lastIndexOf("/"));
		themeId = themeId.split(".");
		themeId = themeId[themeId.length - 2];
		
		ui.theme.themeInfo = ui.theme.getTheme(themeId);
        ui.theme.themeId = ui.theme.themeInfo.Id;
